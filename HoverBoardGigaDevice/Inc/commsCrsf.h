...
#define REMOTE_PARITY USART_PM_NONE
#define REMOTE_WORD_LENGTH USART_WL_8BIT
#define REMOTE_STOP_BIT USART_STB_1BIT

  #define CRSF_THROTTLE_CH 1
  #define CRSF_STEER_CH 0
